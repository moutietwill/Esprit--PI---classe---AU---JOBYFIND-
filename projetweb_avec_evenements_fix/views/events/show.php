...
$hasEvent = isset($event) && is_object($event) && method_exists($event, 'getId');
if (!$hasEvent) {
...
<head>
    ...
    <title>Evenement introuvable</title>
    <style>
        ...
        .card { background: #fff; padding: 28px; border-radius: 12px; box-shadow: 0 10px 24px rgba(15, 23, 42, 0.08); text-align: center; max-width: 520px; }
...
<body>
    <div class="card">
        ...
        <p>Cet evenement n'existe pas ou a ete supprime.</p>
        <a href="/projet/projetweb_avec_evenements_fix/public/index.php/events">Retour aux evenements</a>
    </div>
</body>
</html>
<?php
...
<body>
    <div class="card">
        <p><a href="/projet/projetweb_avec_evenements_fix/public/index.php/events">← Retour</a></p>
        ...
        <div class="actions">
            <?php if ($isComplet): ?>
                <span class="btn" style="background: #ef4444; cursor: not-allowed; opacity: 0.8;">Complet</span>
            <?php else: ?>
                <a class="btn" href="/projet/projetweb_avec_evenements_fix/public/index.php/events/register/<?php echo urlencode((string) $event->getId()); ?>">S'inscrire</a>
            <?php endif; ?>
        </div>
