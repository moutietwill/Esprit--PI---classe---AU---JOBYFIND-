...
<body>
  ...
  <aside class="sidebar">
    ...
    <div class="sidebar-section">
      ...
      <a class="sidebar-link" href="../../public/index.php/admin/inscriptions">
    ...
    <div class="sidebar-section">
      ...
      <a class="sidebar-link" href="../../public/index.php/admin/blog">
    ...
    <div class="sidebar-footer">
      <div class="admin-profile">
        ...
        <button class="logout-btn" title="Déconnexion" onclick="window.location.href='../frontoffice/logout.php'">
