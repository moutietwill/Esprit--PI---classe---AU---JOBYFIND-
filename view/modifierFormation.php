      ...
      <div class="row-1">
        <div class="field-group">
          ...
          <div class="desc-wrapper" style="position: relative;">
            <textarea id="description" name="description" placeholder="Description détaillée de la formation..." style="padding-bottom: 50px;"><?= htmlspecialchars($formation['description']) ?></textarea>
          </div>
          <div class="desc-ai-bar" style="display: flex; align-items: center; justify-content: space-between; margin-top: 6px;">
            <span class="char-count" id="charCount" style="font-size: .76rem; color: var(--gray-400); font-weight: 500;"><?= strlen($formation['description']) ?> car.</span>
            <button type="button" class="btn-ai" id="btnAI" onclick="generateDescription()" style="display: inline-flex; align-items: center; gap: 7px; padding: 8px 18px; border-radius: var(--radius-sm); font-size: .84rem; font-weight: 700; font-family: 'DM Sans', sans-serif; cursor: pointer; border: 1.5px solid var(--gray-200); background: var(--white); color: var(--gray-700); transition: all .25s ease; position: relative; overflow: hidden;">
              <span class="spinner" style="display: none; width: 16px; height: 16px; border: 2px solid var(--gray-200); border-top-color: var(--blue); border-radius: 50%; animation: spin .6s linear infinite;"></span>
              <span class="ai-sparkle" style="font-size: 1.05rem; background: linear-gradient(135deg, #2563EB, #7C3AED); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">✦</span>
              <span class="ai-label">Générer avec l'IA</span>
            </button>
          </div>
          <div class="ai-feedback" id="aiFeedback" style="font-size: .78rem; font-weight: 600; margin-top: 6px; display: flex; align-items: center; gap: 5px; opacity: 0; transition: opacity .3s;"></div>
