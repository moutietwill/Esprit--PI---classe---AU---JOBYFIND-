...
// Specific rule: admin@gmail.com is restricted to the backoffice
$currentUserData = $userController->getUserById($_SESSION['user_id']);
if ($currentUserData && $currentUserData['email'] === 'admin@gmail.com') {
...
<body>
  ...
  <nav>
    ...
    <ul class="nav-links">
      ...
      <li><a href="../../public/index.php/blog">Blog</a></li>
      <li><a href="../../public/index.php/events">Événements</a></li>
      <?php
      ...
      ?>
      <li><a href="<?= $quiz_link ?>">Quiz</a></li>
      <li><a href="../frontoffice.php">Formations</a></li>
      <li><a href="#">À propos</a></li>
      <li><a href="#">Contact</a></li>
    </ul>
    <div class="nav-actions">
      <a class="btn-solid" style="background:var(--blue);border:none;" href="profile.php"><i class="fa fa-user"></i> Mon Profil</a>
  ...
  <main>
    ...
    <div class="right-col">
      <?php if (in_array($_SESSION['role'], ['Admin', 'Tutor', 'Mentor'])): ?>
      <div class="section-card" style="border-left: 5px solid var(--blue); background: #f0f7ff;">
        <div class="section-header">
          <h2 class="section-title" style="color:var(--navy);"><i class="fas fa-shield-halved"></i> Tableau de Bord de Gestion</h2>
        </div>
        <p style="color:#64748b; margin-bottom:20px; font-size:14px;">En tant que <strong><?php echo $_SESSION['role']; ?></strong>, vous avez accès aux modules de gestion suivants :</p>
        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap:15px;">
          <a href="../backoffice/admine.php" class="btn-solid" style="background:#2563eb; text-align:center; padding:12px; text-decoration:none; border-radius:8px; font-weight:600; font-size:14px;">
            <i class="fas fa-users-gear"></i> Utilisateurs
          </a>
          <a href="/yassine/web/view/backoffice/quiz-list-admin.php" class="btn-solid" style="background:#4f46e5; text-align:center; padding:12px; text-decoration:none; border-radius:8px; font-weight:600; font-size:14px;">
            <i class="fas fa-brain"></i> Quiz
          </a>
          <a href="../../public/index.php/admin/events" class="btn-solid" style="background:#0ea5e9; text-align:center; padding:12px; text-decoration:none; border-radius:8px; font-weight:600; font-size:14px;">
            <i class="fas fa-calendar-days"></i> Événements
          </a>
          <a href="../../public/index.php/admin/formations" class="btn-solid" style="background:#3b82f6; text-align:center; padding:12px; text-decoration:none; border-radius:8px; font-weight:600; font-size:14px;">
            <i class="fas fa-graduation-cap"></i> Formations
          </a>
          <a href="../../projetweb/view/backoffice.php" class="btn-solid" style="background:#10b981; text-align:center; padding:12px; text-decoration:none; border-radius:8px; font-weight:600; font-size:14px;">
