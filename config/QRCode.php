...
class QRCode {
    ...
    public static function getEventUrl($eventId) {
        ...
        if (basename($baseDir) === 'public') {
            $publicIndex = $baseDir . '/index.php';
        } else {
            // Find public/index.php relative to the script
            $publicIndex = $baseDir . '/public/index.php';
        }
        
        return $protocol . '://' . $host . $publicIndex . '/events/show/' . $eventId;
    }
    ...
    public static function generateForRegistration($event) {
        ...
        $registrationUrl = $protocol . '://' . $host . $publicIndex . '/events/register/' . $event->getId();
