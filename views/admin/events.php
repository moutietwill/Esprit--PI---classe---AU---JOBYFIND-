...
function clearFormErrors() {
  ...
  form.querySelectorAll('.form-group').forEach(group => {
    ...
    group.querySelector('.form-input').classList.remove('error', 'success');
    group.querySelector('.form-error').textContent = '';
    group.querySelector('.form-error').classList.remove('show');
    group.querySelector('.form-success').textContent = '';
    group.querySelector('.form-success').classList.remove('show');
  });
}
