...
if (realpath(__FILE__) === realpath($_SERVER['SCRIPT_FILENAME'])) {
    ...
    $redirectUrl = preg_replace('@/views/admin(?:/.*)?$@', '/public/index.php/admin/events', $requestUri);
...
$appBase = $baseDir;
if (basename($appBase) === 'public') {
    $appBase = rtrim(dirname($appBase), '/');
}
$blogAdminUrl = (($appBase && $appBase !== '.' && $appBase !== '/') ? $appBase : '') . '/projetweb/view/backoffice.php';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<aside class="sidebar">
  ...
  <div class="sidebar-section">
    ...
    <a class="sidebar-link active" href="<?php echo htmlspecialchars($indexBase . '/admin/events'); ?>">
    ...
    <a class="sidebar-link" href="<?php echo htmlspecialchars($blogAdminUrl); ?>">
      <i class="fa-solid fa-newspaper"></i>
      <span>Back-office blog</span>
    </a>
  </div>
...
<div class="main">
  ...
  <header class="header">
    ...
    <div class="header-search">
      ...
      <input type="text" id="search-input" placeholder="Rechercher un événement, lieu, date..." oninput="filterEventTable()">
    </div>
    ...
    <div class="table-card">
      ...
      <table id="events-table">
        ...
        <tbody id="events-tbody">
          ...
          <tr class="event-row" data-id="<?php echo $event->getId(); ?>">
    ...
    <form id="event-form" method="POST" action="" enctype="multipart/form-data">
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="form-error" data-field="image"></div>
          <div class="form-success" data-field="image"></div>
        </div>
      </div>
...
function openCreateModal() {
  ...
  document.getElementById('event-form').action = getAdminIndexPath() + '/admin/storeEvent';
