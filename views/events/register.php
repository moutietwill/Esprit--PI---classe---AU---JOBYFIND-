...
<body>
    <div class="container">
        <a href="/projetweb_avec_evenements_fix/public/index.php/events/show/<?php echo urlencode((string) $event->getId()); ?>" class="back-link">← Retour à l'événement</a>
    ...
    <script>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch(`/projetweb_avec_evenements_fix/public/index.php/events/inscrire/${eventId}`, {
                    method: 'POST',
                    headers: {
                ...
                if (data.success) {
                    ...
                    form.reset();
                    setTimeout(() => {
                        window.location.href = `/projetweb_avec_evenements_fix/public/index.php/events/show/${eventId}`;
                    }, 2000);
                } else {
