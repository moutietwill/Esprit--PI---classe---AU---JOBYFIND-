...
<body>
    <div class="card">
        ...
        <form method="POST" action="<?php echo htmlspecialchars($url('/events/update/' . urlencode((string) $event->getId())), ENT_QUOTES, 'UTF-8'); ?>" enctype="multipart/form-data">
            ...
            <?php if ($event->getImage()): ?>
                <p>Image actuelle: <?php echo htmlspecialchars($event->getImage(), ENT_QUOTES, 'UTF-8'); ?></p>
            <?php endif; ?>
            <label for="image">Nouvelle image de l'evenement</label>
